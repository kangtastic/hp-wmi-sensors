# Originally sourced from https://github.com/electrified/asus-wmi-sensors/raw/master/Makefile
# and thence from https://github.com/a1wong/it87/blob/master/Makefile
...
MODULE := hp_wmi_sensors

# DKMS
DKMS_ROOT_PATH=/usr/src/$(DRIVER)-$(DRIVER_VERSION)
MODPROBE_OUTPUT=$(shell lsmod | grep $(MODULE))
...
dkms:
	...
	@cp hp-wmi-sensors.c $(DKMS_ROOT_PATH)
